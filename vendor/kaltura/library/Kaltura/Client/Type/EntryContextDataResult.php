 ...
 * @subpackage Client
 */
class EntryContextDataResult extends \Kaltura\Client\ObjectBase
{
	...
	public function __construct(\SimpleXMLElement $xml = null)
	{
		...
		if(empty($xml->accessControlMessages))
			...
			$this->accessControlMessages = \Kaltura\Client\Client::unmarshalItem($xml->accessControlMessages);
		if(empty($xml->accessControlActions))
			$this->accessControlActions = array();
		else
			$this->accessControlActions = \Kaltura\Client\Client::unmarshalItem($xml->accessControlActions);
	}
	/**
	 * 
	 * @var bool
