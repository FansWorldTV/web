...
abstract class DistributionProfile extends \Kaltura\Client\ObjectBase
{
	...
	public function __construct(\SimpleXMLElement $xml = null)
	{
		...
		if(empty($xml->optionalThumbDimensions))
			...
			$this->optionalThumbDimensions = \Kaltura\Client\Client::unmarshalItem($xml->optionalThumbDimensions);
		if(empty($xml->requiredThumbDimensions))
			$this->requiredThumbDimensions = array();
		else
			$this->requiredThumbDimensions = \Kaltura\Client\Client::unmarshalItem($xml->requiredThumbDimensions);
