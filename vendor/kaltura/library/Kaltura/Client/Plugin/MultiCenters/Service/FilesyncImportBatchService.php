 ...
 * @namespace
 */
namespace Kaltura\Client\Plugin\MultiCenters\Service;

/**
 * @package Kaltura
 * @subpackage Client
 */
class FilesyncImportBatchService extends \Kaltura\Client\ServiceBase
{
	 ...
	 * @return array
	 */
	function getExclusiveFileSyncImportJobs(\Kaltura\Client\Type\ExclusiveLockKey $lockKey, $maxExecutionTime, $numberOfJobs, \Kaltura\Client\Type\BatchJobFilter $filter = null)
	{
		$kparams = array();
