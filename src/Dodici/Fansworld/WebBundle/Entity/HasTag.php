...
class HasTag
{
     ...
     * Set tag
     *
     * @param Dodici\Fansworld\WebBundle\Entity\Tag $tag
     */
    public function setTag(\Dodici\Fansworld\WebBundle\Entity\Tag $tag)
    {
        $this->tag = $tag;
    }
     ...
     * Get tag
     *
     * @return Dodici\Fansworld\WebBundle\Entity\Tag 
     */
