...
class HasIdolAdmin extends Admin
{
    public function configureShowFields(ShowMapper $showMapper)
    {
        $showMapper
            ...
            ->add('forumthread', 'orm_many_to_one', array ())
        ;
    }
    ...
    public function configureFormFields(FormMapper $formMapper)
    {
        $formMapper
            ...
            ->add('forumthread', NULL, array (), array ())
        ;
    }
    ...
    public function configureDatagridFilters(DatagridMapper $datagridMapper)
    {
        $datagridMapper
            ...
            ->add('forumthread', 'doctrine_orm_model', array (  'field_type' => 'entity',  'field_options' =>   array (    'class' => 'Dodici\\Fansworld\\WebBundle\\Entity\\ForumThread',  ),  'options' =>   array (  ),  'operator_type' => 'sonata_type_boolean',  'operator_options' =>   array (  ),  'field_name' => 'forumthread',  'mapping_type' => 2,))
        ;
    }
}