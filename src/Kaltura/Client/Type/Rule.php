...
class Rule extends \Kaltura\Client\ObjectBase
{
	...
	public function __construct(\SimpleXMLElement $xml = null)
	{
		...
		if(empty($xml->actions))
			...
			$this->actions = \Kaltura\Client\Client::unmarshalItem($xml->actions);
		if(empty($xml->conditions))
			$this->conditions = array();
		else
			$this->conditions = \Kaltura\Client\Client::unmarshalItem($xml->conditions);
		if(empty($xml->contexts))
			$this->contexts = array();
		else
			$this->contexts = \Kaltura\Client\Client::unmarshalItem($xml->contexts);
