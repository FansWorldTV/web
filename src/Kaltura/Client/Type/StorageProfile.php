...
class StorageProfile extends \Kaltura\Client\ObjectBase
{
	...
	public function __construct(\SimpleXMLElement $xml = null)
	{
		...
		if(empty($xml->pathManagerParams))
			...
			$this->pathManagerParams = \Kaltura\Client\Client::unmarshalItem($xml->pathManagerParams);
		$this->urlManagerClass = (string)$xml->urlManagerClass;
		if(empty($xml->urlManagerParams))
			$this->urlManagerParams = array();
		else
			$this->urlManagerParams = \Kaltura\Client\Client::unmarshalItem($xml->urlManagerParams);
