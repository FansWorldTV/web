...
abstract class ConfigurableDistributionProfile extends DistributionProfile
{
	...
	public function __construct(\SimpleXMLElement $xml = null)
	{
		...
		if(empty($xml->fieldConfigArray))
			...
			$this->fieldConfigArray = \Kaltura\Client\Client::unmarshalItem($xml->fieldConfigArray);
		if(empty($xml->itemXpathsToExtend))
			$this->itemXpathsToExtend = array();
		else
			$this->itemXpathsToExtend = \Kaltura\Client\Client::unmarshalItem($xml->itemXpathsToExtend);
	}
	/**
	 * 
